...
I think I should have to use a difference based on the ACF though. The partial ACF indicates a first order difference of 1. 
...
AutoArima thinks that there should be a first order difference of 1 as well.
